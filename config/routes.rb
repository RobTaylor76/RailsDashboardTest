Rails.application.routes.draw do
  ...
  get "dashboard/test-action-cable", to: "dashboard#test_action_cable"
  ...
  get "dashboard/cleanup-redis-connections", to: "dashboard#cleanup_redis_connections"
